...
class PremiseSidebar extends React.Component {
        ...
        return (
            ...
            <aside className="sidebar-container">
                <div className="sidebar-header" style={{padding:'0'}}>
                    ...
                    <Link to="/dashboard" className="sidebar-header-logo"><img src="img/logo.png" data-svg-replace="img/logo.svg"
                                                                     alt="Logo"/><span
                        className="sidebar-header-logo-text"><img style={{height:'55px',width:'auto'}} src="img/theme/HalloGuest_Logo_White.png" /></span></Link>
                </div>
                <div className="sidebar-content">
                    <div className="sidebar-toolbar text-center">
                        <a href=""><img src="img/user/01.jpg" style={{height:'55px',width:'auto'}} alt="Profile" className="img-circle thumb64"/></a>
                    ...
                    <nav className="sidebar-nav">
                        <ul>
                            ...
                            <li className={this.routeActive('/delivered-requests') ? 'active' : ''}>
                                <Link to="delivered-requests" className="ripple">
                                    ...
                                    <img src="" data-svg-replace="img/icons/aperture.svg" alt="MenuItem"
                                         className="hidden"/></span>
                                    <span>Delivered Requests</span>
                                </Link>
                            </li>
                            <li className={this.routeActive('all-requests') ? 'active' : ''}>
...
PremiseSidebar.contextTypes = {
    router: React.PropTypes.object
};

export default PremiseSidebar;
